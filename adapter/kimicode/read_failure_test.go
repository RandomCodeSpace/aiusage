...
func TestReadAbortWithholdsCheckpointAndReplays(t *testing.T) {
	prefix := "{\"type\":\"llm.request\",\"time\":1780000000000,\"model\":\"kimi-model\",\"modelAlias\":\"alias\",\"turnStep\":\"0.1\"}\n{\"type\":\"usage.record\",\"time\":1780000000001,\"model\":\"alias\",\"usageScope\":\"turn\",\"usage\":{\"inputOther\":10,\"output\":2}}\n"
	body := prefix + "{\"type\":\"usage.record\",\"time\":1780000000002,\"model\":\"alias\",\"usageScope\":\"turn\",\"usage\":{\"inputOther\":20,\"output\":3}}\n"
