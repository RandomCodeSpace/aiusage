...
//
// ACCEPTED BASELINE (issue #41/#82): 19 allocs/op, ~2.6 KB/op. It drifted 37 -> 50
...
// and the 19 that remain buy stable cache keys, per-caller summary copies,
// scrub compositions, and grouping slices. The timeline's exact Totals now
// replaces the former redundant ungrouped-total query.
//
